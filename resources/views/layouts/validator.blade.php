        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="{{ route('validation.index_iku') }}">Nilai Indikator Kinerja Utama</a></li>
                  <li><a class="dropdown-item" href="{{ route('validation.index_iki') }}">Nilai Indikator Kinerja Individu</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <form class="d-flex">
                ...
                <div class="d-flex align-items-center me-2"><b>Validator</b></div>
